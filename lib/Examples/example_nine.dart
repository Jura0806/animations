...
class ExampleNine extends StatefulWidget {
  ...
  static const String id = "/example_9";

  @override
  State<ExampleNine> createState() => _ExampleNineState();
}

class _ExampleNineState extends State<ExampleNine> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Interactive Promt Box"),
      ),
      body: const Center(
